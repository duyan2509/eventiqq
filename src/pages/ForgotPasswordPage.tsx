      ...
      <div className="mx-auto max-w-md fade-in">
        <div className="glass p-8 text-center">
          ...
          <p className="text-sm text-slate-400 mb-6">
            If an account exists with <strong className="text-indigo-300">{email}</strong>, we've sent a password reset token to that address.
          </p>
    ...
    <div className="mx-auto max-w-md fade-in">
      <div className="glass p-8">
        <div className="mb-6 flex flex-col items-center gap-2">
          ...
          <p className="text-sm text-slate-400 text-center">Enter your email address and we'll send you a token to reset your password.</p>
        </div>
